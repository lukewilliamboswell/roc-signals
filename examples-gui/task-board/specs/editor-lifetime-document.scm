(test "An opened document selects nothing, so no editor survives it"
  (steps
    ...
    (stub-file-read "board-read" :path "/tmp/project.board.json" :text "{\"version\":1,\"next\":2,\"planned\":[{\"key\":\"task-1\",\"title\":\"Reused key\",\"notes\":\"\",\"assignee\":\"Unassigned\",\"priority\":\"Normal\"}],\"progress\":[],\"complete\":[]}")
