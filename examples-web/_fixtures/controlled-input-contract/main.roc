				...
				[
					...
					Html.text_input_attrs(
						...
						[
							...
							Html.on_composition_start(model.update(record_composition_start)),
							Html.on_composition_end(model.update(record_composition_end)),
						],
						model.update_str(record_normalized),
					),
					Html.text_input_attrs(
						"Echo draft",
						echo_signal,
