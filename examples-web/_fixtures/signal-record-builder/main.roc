							...
							Html.div_c(
								...
								[
									...
									Html.form_label(
										...
										[
											Html.text_input_c("First name", first.signal(), input_class, first.update_str(|_, value| value)),
											Html.text_input_c("Last name", last.signal(), input_class, last.update_str(|_, value| value)),
											Html.checkbox("Active profile", active.signal(), active.update_bool(|_, checked| checked)),
											Html.paragraph_s_c(summary, "text-sm text-zinc-700"),
											Html.paragraph_s_c(ready, "text-sm font-medium text-zinc-900"),
											Html.action_button(Signal.const("Continue"), disabled, first.update(|value| value)),
										],
									),
								],
							)
