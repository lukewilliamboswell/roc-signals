	...
	Html.section(
		...
		[
			...
			Html.div_c(
				...
				[
					icon_button({ glyph: "←", label: "Move left: ${key}", classes: icon_class }, left_disabled, board.update(|state| move_across(state, key, Leftward))),
					icon_button({ glyph: "→", label: "Move right: ${key}", classes: icon_class }, right_disabled, board.update(|state| move_across(state, key, Rightward))),
					icon_button({ glyph: "↑", label: "Move up: ${key}", classes: icon_class }, up_disabled, board.update(|state| move_within(state, key, Upward))),
					icon_button({ glyph: "↓", label: "Move down: ${key}", classes: icon_class }, down_disabled, board.update(|state| move_within(state, key, Downward))),
					icon_button({ glyph: "⚑", label: "Flag: ${key}", classes: icon_class }, Signal.const(False), board.update(|state| flag_card(state, key))),
					icon_button({ glyph: "✕", label: "Delete: ${key}", classes: delete_icon_class }, Signal.const(False), board.update(|state| delete_card(state, key))),
				],
			),
		],
	)
												...
												[
													labelled_field(
														...
														Html.text_input_attrs(
															...
															filter.update_str(|_, value| value),
														),
													),
													labelled_field(
														"WIP limit",
													...
													labelled_field(
														...
														Html.text_input_attrs(
															...
															board.update_str(|state, value| { ..state, draft: value }),
														),
													),
													Html.action_button_attrs(
														...
														board.update(|state| add_card(state)),
													),
												],
											),
