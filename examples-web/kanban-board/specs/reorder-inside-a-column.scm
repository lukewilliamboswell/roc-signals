(test "Kanban board — reorder inside a column"
  (steps
    ...
    (expect-text (test-id "card-position-Draft onboarding copy") "1 of 2 in In Progress")
    (expect-text (test-id "card-position-Ship search filters") "2 of 2 in In Progress")
