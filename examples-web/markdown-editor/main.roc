			...
			Html.div_c(
				...
				[
					Html.div_c(
						...
						[
							...
							Html.textarea_c(
								...
								source.update_str(|_, value| value),
							),
					...
					button_group(
						"Documents",
						[
							Html.button_c("Load sample document", "button button-primary button-sm", source.update(|_| sample_document)),
							Html.button_c("Load document without headings", "button button-sm", source.update(|_| no_heading_document)),
							Html.button_c("Load heading drill", "button button-sm", source.update(|_| heading_drill_document)),
						],
					),
					button_group(
						"Edit the document",
						[
							Html.button_c("Append a word", "button button-sm", source.update(Edit.append_word)),
							Html.button_c("Append a section", "button button-sm", source.update(Edit.append_section)),
							Html.button_c("Move the last section up", "button button-sm", source.update(Edit.move_last_section_up)),
							Html.button_c("Demote the last heading", "button button-sm", source.update(Edit.demote_last_heading)),
							Html.button_c("Remove the last section", "button button-sm", source.update(Edit.remove_last_section)),
							Html.button_c("Clear document", "button-danger button-sm", source.update(|_| "")),
						],
					),
				],
			),
			...
			Html.div_c(
				...
				[
					...
					Html.div_c(
						"check-row",
						[
							Html.checkbox_c("Number the outline", numbered_signal, "checkbox", numbered.update_bool(|_, value| value)),
					...
					Html.div_c(
						...
						[
							...
							Html.select_c(
								...
								speed.update_str(|_, value| value),
							),
