(test "Recipe scaler — Scaling down, rounding, and the boundaries"
  (steps
    ...
    (expect-text (test-id "effective-servings") "Effective servings: 3")
    ...
    (expect-text (test-id "effective-servings") "Effective servings: 1")
    ...
    (expect-text (test-id "effective-servings") "Effective servings: 0")
