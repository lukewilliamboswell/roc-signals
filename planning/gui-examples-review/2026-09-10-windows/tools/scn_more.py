...
run_nohome("task-board", "board-save-as", ["--host-assets-root", str(ROOT / "examples-gui/task-board/assets")], (196,134))
...
# --- explorer extras
s = start("folder-explorer", ["--host-assets-root", str(ROOT / "examples-gui/folder-explorer/assets")])
def choose(path):
