platform ""
	...
	targets: {
        ...
        x64glibc: { inputs: ["crt1.o", "crti.o", "libsignals_gpui_host.a", "libengine.a", app, "libfreetype.so", "libxkbcommon.so", "libxkbcommon-x11.so", "libgcc_s.so", "libm.so", "libc.so", "crtn.o"] },
