platform ""
	...
	targets: {
		...
		wasm32: {
			...
			output: Shared,
			exports: ["__stack_pointer", "roc_ui_effect_stack_top", "roc_ui_effect_stack_bottom", "roc_ui_effect_stack_main", "roc_ui_effect_next", "roc_ui_effect_run", "roc_ui_effect_complete", "roc_alloc", "roc_dealloc", "roc_ui_debug_live_allocation_bytes", "roc_ui_debug_live_allocation_count", "roc_ui_debug_live_allocation_phase", "roc_ui_debug_live_allocation_size", "roc_ui_command_buffer_clear", "roc_ui_command_buffer_len", "roc_ui_command_buffer_ptr", "roc_ui_command_record_words", "roc_ui_dynamic_buffer_len", "roc_ui_dynamic_buffer_ptr", "roc_ui_event", "roc_ui_last_error_len", "roc_ui_last_error_ptr", "roc_ui_live_host_values", "roc_ui_mount", "roc_ui_prepare_mount", "roc_ui_protocol_features", "roc_ui_protocol_version", "roc_ui_set_entropy_seed", "roc_ui_set_location", "roc_ui_set_online", "roc_ui_set_storage_payload", "roc_ui_set_visibility", "roc_ui_storage_declaration_area", "roc_ui_storage_declaration_count", "roc_ui_storage_declaration_key_len", "roc_ui_storage_declaration_key_ptr", "roc_ui_string_buffer_len", "roc_ui_string_buffer_ptr", "roc_ui_timer", "roc_ui_unmount", "roc_ui_update_location", "roc_ui_update_online", "roc_ui_update_visibility"],
		},
